<x-frontend-layout title="Checkout" description="this is meta description" keywords="this is meta keywords">
    ...
    <section class="container mx-auto py-6 px-4 md:px-6">
        <div class="checkout-container mx-auto py-8 px-4 md:px-6">
            ...
            <form action="{{ route('order.store', $shop->id) }}" method="POST" class="space-y-6" id="checkoutForm"
