            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class=" sm:my-5">
                    ...
                    <ul class="space-y-2 lg:mt-10 text-white">
                        ...
                        <li><a class="hover:text-red-500 duration-300 hover:underline" href="#">Celebrate with
                                us</a></li>
                        <li><a class="hover:text-red-500 duration-300 hover:underline" href="#">Coupones &
                                Offers</a></li>
                    </ul>
                </div>
                <div class=" sm:my-5">
                    ...
                    <ul class="space-y-2 lg:mt-10 text-white">
                        ...
                        <li><a class="hover:text-red-500 duration-300 hover:underline" href="#">Cancellation and
                                Refund</a></li>
                        <li><a class="hover:text-red-500 duration-300 hover:underline" href="#">Privacy Policy</a>
                        </li>
                        <li><a class="hover:text-red-500 duration-300 hover:underline" href="#">Terms and
                                Conditions</a></li>
                    </ul>
                </div>
                <div class=" sm:my-5">
                    ...
                    <ul class="space-y-2 mt-10 text-white">
                        <li><a class="hover:text-red-500 duration-300 hover:underline" href="#">+977 -
                                9804334359</a></li>
                        <li><a class="hover:text-red-500 duration-300 hover:underline" href="#">987-987-987</a>
                        </li>
                    </ul>
                </div>
            </div>
